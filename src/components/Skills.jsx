...
// import { SiMongodb, SiExpress, SiPostman, SiFigma } from "react-icons/si";
...
//                bg-[#0f172a]/60 backdrop-blur-md border border-[#1e293b] 
//                shadow-[0_0_15px_rgba(56,189,248,0.2)] hover:shadow-[0_0_25px_rgba(56,189,248,0.4)] 
//                transition-all duration-500 cursor-default"
//   >
//     <div className="text-4xl mb-3 drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]">{icon}</div>
//     <h4 className="font-medium text-[#e2e8f0]">{name}</h4>
//   </motion.div>
// );
